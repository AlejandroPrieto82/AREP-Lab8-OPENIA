...
![Creación entorno virtual](image.png)
...
![Obtener la llave de la API](image-1.png)
...
![Rectificar generación, activación, instalación de dependencias](image-4.png)
...
![Instalación Jupyter](image-6.png)
...
![Creación carpeta](image-7.png)
**Figura 2.** Creación de la carpeta del proyecto.

![Creación de entorno](image-8.png)
...
![Dependencias 1](image-9.png)
![Dependencias 2](image-10.png)
...
![Instalación dependencias desde archivo](image-11.png)
...
![Ingresar códigos a las celdas para ejecución](image-12.png)
**Figura 7.** Ejecución del código en celdas del notebook.

![Resultados de ejecución](image-13.png)
